...
- 根据 Github 用户 monkey7581sss888 的补丁，成功让宝可装置显示完整的星期X。同理也搞定了宝可梦的「地面」属性字数问题。
...
- 真正意义的中文输入法
- 战斗中的使用出招提示「XXX 的 XXX」，或者「XXX XX」这部分因为原ROM内容编排以及韩文语序问题很难改动。
- 神秘礼物流程未测试，神秘礼物标题界面图片有缺损
- 获得全图鉴的奖状字样，保留韩语 표창장
- 星期几显示问题：将使用竖排小字替代
- 因字节限制做的改动：
	...
	- 游戏初始界面的「周X」，「那座城 这些人」「清晨」「白天」「晚上」「招式学习器」「秘传学习器」「小刚」「名人堂记录」使用 8*8 小字竖排
	- 部分剧情文本
